...
### code for test
javac -cp "lib/*" -d M5/bin M5/src/main/java/persons/*.java M5/src/test/java/persons/*.java
java -cp "lib/junit-platform-console-standalone-1.9.0.jar;M5/bin;lib/*" org.junit.platform.console.ConsoleLauncher --scan-class-path